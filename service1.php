...
<script>
  ...
  <!----------->
    ...
    <header  class="fixed left-0 top-0 w-full z-50  mb-10 ">
        <nav class="flex items-center  p-3 flex-wrap " id="navbar" style="background-color: #212121;">
     ...
     <div id="navig" class="top-nav w-full lg:inline-flex lg:flex-grow lg:w-auto">
            <div class="lg:inline-flex lg:flex-row lg:m-auto flex flex-col font-semibold hidden " id="toggle">
                <a href="home1.php" class="lg:inline-flex lg:w-auto px-3 py-2 rounded-full  text-white  menu w-24 " >
   ...
   <div class="  grid   md:grid-cols-3 sm:grid-cols-2    grid-cols-1 justify-items-center mx-4 lg:my-24 sm:my-56  ">
...
<div class=" flex md:flex-row flex-col justify-items-center z-20 lg:m-24 md:m-16 m-24  " id="1"> 
    <img src="image/CAO-DAO.jpeg" class="rounded-3xl  md:w-1/2 w-full md:w-96 h-56  lg:ml-24 md:ml-5   " data-aos="fade-right"  data-aos-duration="2000" alt="CAO-DAO.jpeg">
   <div class="md:px-10  sm:py-1/2 w-full h-1/2  ">
       <h1 class="md:text-left text-center pt-5 pb-10 font-bold sm:text-4xl text-xl title-h2 "><?php echo $lang['title-CAO'] ?> </h1>
        <p class="md:text-left text-left text-sm lg:w-3/4  md:w-full   " data-aos="zoom-in-left" data-aos-duration="1500"><?php echo $lang['Para-C-A-D'] ?></p>
    
        <div>  <ul class="about-link justify-items-center sm:w-full  w-3/4 "> 
        <li><a href="https://www.facebook.com/Nissed-Manufacturing-108347454661551" ><i class="fa fa-facebook sm:m-0 m-2 sm:w-12 sm:h-12 w-10 h-10"></i></a></li>       
         <li><a href="https://mail.google.com/mail/u/0/#inbox"><i class="fa fa-envelope sm:m-0 m-2 sm:w-12 sm:h-12 w-10 h-10"></i></a></li>
...
<div class=" flex md:flex-row flex-col justify-items-center z-20 lg:m-24 md:m-16 m-24  " id="2"> 
    <img src="image/sourcing industriel5.jpeg" class="rounded-3xl md:w-1/2 w-full md:w-96 h-56  lg:ml-24 md:ml-5   " data-aos="fade-right"  data-aos-duration="2000" alt="sourcing industriel">
   <div class="md:px-10  sm:py-1/2 w-full h-1/2 ">
...
<div class=" flex md:flex-row flex-col justify-items-center z-20 lg:m-24 md:m-16 m-24  " id="3"> 
    <img src="image/CONTROLE QUALITE.jpeg" class="rounded-3xl md:w-1/2 w-full md:w-96 h-56  lg:ml-24 md:ml-5   " data-aos="fade-right"  data-aos-duration="2000" alt="CONTROLE QUALITE">
   <div class="md:px-10  sm:py-1/2 w-full h-1/2 ">
       <h1 class="md:text-left text-center pt-5 pb-10 font-bold sm:text-4xl text-xl title-h2 "><?php echo $lang['title-C-Q'] ?></h1>
        <p class="md:text-left text-left text-sm lg:w-3/4  md:w-full   " data-aos="zoom-in-left" data-aos-duration="1500"><?php echo $lang['Para-C-Q'] ?></p>
...
<div class=" flex md:flex-row flex-col justify-items-center z-20 lg:m-24 md:m-16 m-24  " id="4"> 
    <img src="image/FAO.jpg" class="rounded-3xl md:w-1/2 w-full md:w-96 h-56  lg:ml-24 md:ml-5   " data-aos="fade-right"  data-aos-duration="2000" alt="Hydraulic">
   <div class="md:px-10  sm:py-1/2 w-full h-1/2 ">
       <h1 class="md:text-left text-center pt-5 pb-10 font-bold sm:text-4xl text-xl title-h2 "><?php echo $lang['title-H'] ?></h1>
        <p class="md:text-left text-left text-sm lg:w-3/4  md:w-full   " data-aos="zoom-in-left" data-aos-duration="1500"><?php echo $lang['Para-H'] ?></p>
...
<div class=" flex md:flex-row flex-col justify-items-center z-20 lg:m-24 md:m-16 m-24  " id="5"> 
    <img src="image/CAO-DAO.jpeg" class="rounded-3xl md:w-1/2 w-full md:w-96 h-56  lg:ml-24 md:ml-5" data-aos="fade-right"  data-aos-duration="2000" alt="Pneumatic">
   <div class="md:px-10  sm:py-1/2 w-full h-1/2 ">
       <h1 class="md:text-left text-center pt-5 pb-10 font-bold sm:text-4xl text-xl title-h2 "><?php echo $lang['title-P'] ?></h1>
        <p class="md:text-left text-left text-sm lg:w-3/4  md:w-full   " data-aos="zoom-in-left" data-aos-duration="1500"><?php echo $lang['Para-P'] ?></p>
...
<!-- bloc6 -->
  <div class=" flex md:flex-row flex-col justify-items-center z-20 lg:m-24 md:m-16 m-24  " id="6"> 
    <img src="image/ELECTRICITE.jpg" class="rounded-3xl md:w-1/2 w-full md:w-96 h-56  lg:ml-24 md:ml-5   " data-aos="fade-right"  data-aos-duration="2000" alt="ELECTRICITE">
   <div class="md:px-10  sm:py-1/2 w-full h-1/2 ">
       <h1 class="md:text-left text-center pt-5 pb-10 font-bold sm:text-4xl text-xl title-h2 "><?php echo $lang['title-E'] ?></h1>
        <p class="md:text-left text-left text-sm lg:w-3/4  md:w-full   " data-aos="zoom-in-left" data-aos-duration="1500"><?php echo $lang['Para-E'] ?></p>
...
<!-- bloc7 -->
  <div class=" flex md:flex-row flex-col justify-items-center z-20 lg:m-24 md:m-16 m-24  " id="7"> 
    <img src="image/CAO-DAO.jpeg" class="rounded-3xl   md:w-1/2 w-full md:w-96 h-56  lg:ml-24 md:ml-5   " data-aos="fade-right"  data-aos-duration="2000" alt="CAO-DAO">
   <div class="md:px-10  sm:py-1/2 w-full h-1/2 ">
       <h1 class="md:text-left text-center pt-5 pb-10 font-bold sm:text-4xl text-xl title-h2 "><?php echo $lang['title-fao'] ?></h1>
        <p class="md:text-left text-left text-sm lg:w-3/4  md:w-full   " data-aos="zoom-in-left" data-aos-duration="1500"><?php echo $lang['Para-fao'] ?></p>
  ...
  <!-- bloc8 -->
  <div class=" flex md:flex-row flex-col justify-items-center z-20 lg:m-24 md:m-16 m-24  " id="6"> 
    <img src="image/CREATION SITE WEB LOGO CHARTE GRAPHIQUE PACKAGING.jpeg" class="rounded-3xl md:w-1/2 w-full md:w-96 h-56  lg:ml-24 md:ml-5 " data-aos="fade-right"  data-aos-duration="2000" alt="CREATION SITE WEB LOGO CHARTE GRAPHIQUE PACKAGING">
   <div class="md:px-10  sm:py-1/2 w-full h-1/2 ">
       <h1 class="md:text-left text-center pt-5 pb-10 font-bold  sm:text-4xl text-xl title-h2 "><?php echo $lang['title-web'] ?></h1>
        <p class="md:text-left text-left text-sm lg:w-3/4  md:w-full   " data-aos="zoom-in-left" data-aos-duration="1500"><?php echo $lang['Para-web'] ?></p>
