...
L’idée est vite apparue qu’il était intéressant de proposer les services de jeunes diplômés tunisiens">
	<meta name="keywords" content=" Nissed ,NISSED,nissed,Nissed manufacturing,nissed manufacturing,Manufacturing,MANUFACTURING,CAO,Sourcing ,Sourcing Industriel">
	...
	<title>Nissed-Manufacturing nissed manufacturing</title>
</head>
...
<body>
	...
	<!-- ----- -->
	<!-- counter -->
	<section id="count-er" class=" flex justify-center">
		<div class="loader  top-1/2"></div>
		<div class="count"></div>
		<div>
			<img src="image/Logo 120x120.png" class="relative top-1/3 md:top-1/4 md:w-44 md:h-44 " alt="Nissed manufacturing">
		</div>
	</section>
	...
	<!-- ---------->
	<div id=body>
		<header class="fixed left-0 top-0 w-full z-50  " id="header">
			<nav class="flex items-center bg-transparent p-3 flex-wrap " id="navbar">
				...
				<div id="navig" class="top-nav w-full lg:inline-flex lg:flex-grow lg:w-auto">
					<div class="lg:inline-flex lg:flex-row lg:m-auto flex flex-col font-semibold hidden  " id="toggle">
						<a href="#" class="lg:inline-flex lg:w-auto px-3 py-2 rounded-full  text-black  menu w-24 "> <span class="items-nav-nav"><?php echo $lang['navbar-item-1'] ?></span>
						</a>
						<a   onclick="window.open('service1.php')"  class="cursor-pointer lg:inline-flex lg:w-auto px-3 py-2 rounded-full text-white menu w-24 "> <span class="items-nav-nav"><?php echo $lang['navbar-item-2'] ?></span>
						</a>
						<a  onclick="window.open('about1.php')" class="cursor-pointer lg:inline-flex lg:w-auto px-3 py-2 rounded-full text-white menu w-24"> <span class="items-nav-nav"><?php echo $lang['navbar-item-3'] ?></span>
						</a>
						...
						<div class=" relative mt-1 lg:left-1/2 left-4 text-white"> <a href="index.php?lang=fr" class=" hover:text-blue-500"><span class="items-nav-nav">Fr</span></a> / <a href="index.php?lang=en" class="hover:text-blue-500"><span class="items-nav-nav"  >Eng</span></a>
						</div>
					</div>
				</div>
		...
		<main>
			<div class="relative flex w-full">
				<div class="z-20 absolute left-0 top-0 flex flex-col items-center justify-center w-full h-full text-white p-4">
                    ...
                    <a data-aos="zoom-in" data-aos-duration="3000" onclick="playPause()" title="Choose Music" id="btn"  class="animate-bounce cursor-pointer px-10 py-3 md:text-xl sm:text-lg text-sm btn1">
					<?php echo $lang[ 'choose-mus'] ?>
					</a>
				</div>
				<video src="video/vd1.mp4" id="video1" class="filter-dark w-full h-auto md:min-h-auto min-h-screen object-cover" muted loop ></video>
			</div>
		</main>
        <script>
    ...
    btn.style.display ="none"; 
		...
		<section id="music">
			<div class="flex  justify-center">
				<h1 class=" text-center md:text-5xl  text-3xl title-h1 " data-aos="fade-down-right" data-aos-duration="2000"><?php echo $lang['title-musi'] ?></h1>
			</div>
			<div class="flex  justify-center animate-bounce">
				<h1 class=" show-btn text-xl  w-10 h-10 mt-7 rounded-full text-center transition duration-500 ease-in-out  transform hover:-translate-y-1 hover:scale-90 pt-2  " style="background-color:#000000;">v</h1>
			</div>
			<div class="grid grid-cols-1 md:grid-cols-4  justify-center m-24 ">
				<!-- music1 -->
				<div class="flex flex-col" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1000" onclick="playlist(0)">
				...
				<!-- music2 -->
				<div class="flex flex-col" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1000" onclick="playlist(1)">
				...
				<!-- music3 -->
				<div class="flex flex-col" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1000" onclick="playlist(2)">
				...
				<!-- music4 -->
				<div class="flex flex-col" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1000" onclick="playlist(3)">
				...
				<!-- music5 -->
				<div class="flex flex-col" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1000" onclick="playlist(4)">
				...
				<!-- music6 -->
				<div class="flex flex-col" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1300" onclick="playlist(5)">
				...
				<!-- music7 -->
				<div class="flex flex-col" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1300" onclick="playlist(6)">
				...
				<!-- music8 -->
				<div class="flex flex-col" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1300" onclick="playlist(7)">
			...
			<div class="flex  justify-center mb-10">
				<h1 class=" text-center md:text-5xl  text-3xl title-h1" data-aos="fade-down-right" data-aos-duration="3000">Services</h1>
			</div>
		</section>
		<div id="aplayer"></div>
		...
		<section id="service">
			<div class="container">
				<div class="card" data-aos="fade-down" data-aos-offset="300" data-aos-easing="ease-in-sine">
					<div class="content">
						<h2 class="title-card"><?php echo $lang['title-CAO'] ?></h2>
						<p>
							<?php echo $lang[ 'text-CAO'] ?>
						</p>
						<a onclick="window.open('service1.php')" class="cursor-pointer" >
		...
		<footer>
			<div class="grid md:grid-cols-3 py-16 sm:px-24 grid-cols-1 px-16 " id="footer-contact">
				...
				<div class=" flex flex-col mb-10 md:justify-self-center" data-aos="fade-down" data-aos-duration="1500">
					...
					<a onclick="window.open('service1.php')" class="text-light text-white hover:text-gray-400 cursor-pointer">
						<?php echo $lang[ 'navbar-item-2'] ?>
					</a>
					<a onclick="window.open('about1.php')" class="text-light text-white hover:text-gray-400 cursor-pointer">
