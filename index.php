			...
			<nav class="flex items-center bg-transparent p-3 flex-wrap " id="navbar">
				...
				<div id="navig" class="top-nav w-full lg:inline-flex lg:flex-grow lg:w-auto">
					<div class="lg:inline-flex lg:flex-row lg:m-auto flex flex-col font-semibold hidden  " id="toggle">
						<a href="#" class="lg:inline-flex lg:w-auto px-3 py-2 rounded-full  text-black  menu w-24 "> <span><?php echo $lang['navbar-item-1'] ?></span>
						</a>
						<a href="service1.php" class="lg:inline-flex lg:w-auto px-3 py-2 rounded-full text-white menu w-24 "> <span><?php echo $lang['navbar-item-2'] ?></span>
						</a>
						<a href="about1.php" class="lg:inline-flex lg:w-auto px-3 py-2 rounded-full text-white menu w-24"> <span><?php echo $lang['navbar-item-3'] ?></span>
						</a>
						<a href="#footer-contact" class="lg:inline-flex lg:w-auto px-3 py-2 rounded-full text-white menu w-24"> <span><?php echo $lang['navbar-item-4'] ?></span>
						</a>
						<div class=" relative mt-1 lg:left-1/2 left-4 text-white"> <a href="index.php?lang=fr" class=" hover:text-blue-500"><span>Fr</span></a> / <a href="index.php?lang=en" class="hover:text-blue-500"><span >Eng</span></a>
						</div>
					</div>
				</div>
		...
		<main>
			<div class="relative flex w-full">
				<div class="z-20 absolute left-0 top-0 flex flex-col items-center justify-center w-full h-full text-white p-4">
					<!-- <a data-aos="zoom-in" data-aos-duration="3000" title="Choose Music" href="#music" class="animate-bounce mt-10 px-10 py-3 md:text-xl sm:text-lg text-sm btn1">
						<?php echo $lang[ 'choose-mus'] ?>
					</a> -->
                    <a data-aos="zoom-in" data-aos-duration="3000" onclick="playPause()" title="Choose Music"  class="animate-bounce px-10 py-3 md:text-xl sm:text-lg text-sm btn1">
						play vd
					</a>
				</div>
				<video src="video/vd1.mp4" id="video1" class="filter-dark w-full h-auto md:min-h-auto min-h-screen object-cover" ></video>
			</div>
		</main>
        <script>
    ...
    myVideo.pause(); 
		...
		<footer>
			<div class="grid sm:grid-cols-3 py-16 sm:px-24 grid-cols-1 px-16 " id="footer-contact">
				<div class="mb-10" data-aos="fade-down" data-aos-duration="1500">
				...
				<div class=" flex flex-col mb-10 sm:justify-self-center" data-aos="fade-down" data-aos-duration="1500">
					...
					<a href=" " class="text-light text-white hover:text-gray-400">
